...
workflow-stage-navigation + editorial-decisions 2026-07-16; Area 1 sampled and
approved 2026-07-14; findings-to-files protocol in force since — see RUNBOOK).

## Totals

- Features: **1 reference · 8 verified · 83 pending** (of 92; feature 39 folded into `article-landing`)
...
| 8 | Area 2 — Editorial workflow & peer review | `editorial-decisions` | H·13 | in_progress | pending | SPEC verified & KEPT (fable-clean, 43 atoms, ledger rows 214–219 + row-10 addendum stand); wave-7 tests + DecisionWizardPage POM REMOVED 2026-07-21 (lib/pkp revert ad338c097b) by maintainer directive after static review found s12 assertion defects in the opus-tail half (test-author had flipped 122/232) — re-author tests FABLE-CLEAN per `.reports/editorial-decisions-test-reauthor-brief.md` (RUNBOOK steps 5–9 only; s12 arbitration outcome superseded by the brief) |
