...
| 8 | Area 2 — Editorial workflow & peer review | `editorial-decisions` | H·13 | pending | pending | FROM-SCRATCH REBUILD (maintainer, 2026-07-21): wave-7 spec + tests + POM scrapped (lib/pkp revert ad338c097b, spec removed in root) after static review of the opus-tail authored suite; ledger rows 214–219 + row-10 addendum STAND; full loop steps 1–11, authoring must be FABLE-CLEAN (discard+respawn flipped authoring chunks) — read `.reports/editorial-decisions-test-reauthor-brief.md` BEFORE claiming |
