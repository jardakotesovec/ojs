...
| PAGE-authordashboard-reviewroundinfo | AuthorDashboardHandler::reviewRoundInfo | pages/authorDashboard/index.php | Op routed in switch; no matching handler method found (dead) | author-dashboard.md (documented-dead — AD-C; intentionally not claimed) | |
...
| PAGE-decision-record | DecisionHandler::record | lib/pkp/pages/decision/DecisionHandler.php | Record an editorial decision, reached via pages/decision | editorial-decisions.md | editorial-decisions |
