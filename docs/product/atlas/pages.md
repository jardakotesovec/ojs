...
| PAGE-submission-index | SubmissionHandler::index (inherited) | pages/submission/SubmissionHandler.php | Submission wizard landing/start page | submission-wizard-core.md | |
| PAGE-submission-saved | SubmissionHandler::saved (inherited) | pages/submission/SubmissionHandler.php | Submission-saved confirmation page | submission-wizard-core.md | |
| PAGE-submission-wizard | SubmissionHandler::wizard (inherited, @deprecated 3.4) | pages/submission/SubmissionHandler.php | Deprecated submission wizard URL | submission-wizard-core.md | |
| PAGE-submission-cancelled | SubmissionHandler::cancelled (inherited) | pages/submission/SubmissionHandler.php | Submission-cancelled confirmation page | submission-wizard-core.md | |
