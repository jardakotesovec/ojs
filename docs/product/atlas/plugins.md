...
| PLUGIN-generic-recommendByAuthor | plugins/generic/recommendByAuthor | RecommendByAuthorPlugin.php | Recommend other articles by same author; no settings form (context) | article-landing e2e | article-landing (reader footer block, Templates::Article::Footer::PageFooter; off by default) — empties article-recommendations (feature 39), see article-landing Open question 3 |
| PLUGIN-generic-recommendBySimilarity | plugins/generic/recommendBySimilarity | RecommendBySimilarityPlugin.php | Recommend similar articles by keyword match; no settings form (context) | article-landing e2e | article-landing (reader footer block, Templates::Article::Footer::PageFooter; off by default) — empties article-recommendations (feature 39), see article-landing Open question 3 |
| PLUGIN-generic-staticPages | plugins/generic/staticPages | StaticPagesPlugin.php | Create/manage custom static content pages; has management form (context). Ships DISABLED (lazy-load, no default enable) — live-verified 2026-07-05 disabled on test journal → custom paths 404 | public-pages e2e | about-pages |
