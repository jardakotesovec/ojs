...
namespace APP\plugins\themes\oreTheme;
...
class OreThemePlugin extends \PKP\plugins\ThemePlugin
{
    /**
    ...
    public function init()
    {
        ...
        $this->addOption('typography', 'FieldOptions', [
            'type' => 'radio',
            'label' => __('plugins.themes.oreTheme.option.typography.label'),
            'description' => __('plugins.themes.oreTheme.option.typography.description'),
            'options' => [
                [
                    'value' => 'notoSans',
                    'label' => __('plugins.themes.oreTheme.option.typography.notoSans'),
                ],
                [
                    'value' => 'notoSerif',
                    'label' => __('plugins.themes.oreTheme.option.typography.notoSerif'),
                ],
                [
                    'value' => 'notoSerif_notoSans',
                    'label' => __('plugins.themes.oreTheme.option.typography.notoSerif_notoSans'),
                ],
                [
                    'value' => 'notoSans_notoSerif',
                    'label' => __('plugins.themes.oreTheme.option.typography.notoSans_notoSerif'),
                ],
                [
                    'value' => 'lato',
                    'label' => __('plugins.themes.oreTheme.option.typography.lato'),
                ],
                [
                    'value' => 'lora',
                    'label' => __('plugins.themes.oreTheme.option.typography.lora'),
                ],
                [
                    'value' => 'lora_openSans',
                    'label' => __('plugins.themes.oreTheme.option.typography.lora_openSans'),
                ],
            ],
            'default' => 'notoSans',
        ]);
        ...
        $this->addOption('baseColour', 'FieldColor', [
            'label' => __('plugins.themes.oreTheme.option.colour.label'),
            'description' => __('plugins.themes.oreTheme.option.colour.description'),
            'default' => '#1E6292',
        ]);
        ...
        $this->addOption('showDescriptionInJournalIndex', 'FieldOptions', [
            ...
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.oreTheme.option.showDescriptionInJournalIndex.option'),
                ],
            ],
            'default' => false,
        ]);
        ...
        $this->addOption('useHomepageImageAsHeader', 'FieldOptions', [
            'label' => __('plugins.themes.oreTheme.option.useHomepageImageAsHeader.label'),
            'description' => __('plugins.themes.oreTheme.option.useHomepageImageAsHeader.description'),
            'options' => [
                [
                    'value' => true,
                    'label' => __('plugins.themes.oreTheme.option.useHomepageImageAsHeader.option')
                ],
            ],
            'default' => false,
        ]);
        $this->addOption('displayStats', 'FieldOptions', [
            'type' => 'radio',
            'label' => __('plugins.themes.oreTheme.option.displayStats.label'),
            'options' => [
                [
                    'value' => 'none',
                    'label' => __('plugins.themes.oreTheme.option.displayStats.none'),
                ],
                [
                    'value' => 'bar',
                    'label' => __('plugins.themes.oreTheme.option.displayStats.bar'),
                ],
                [
                    'value' => 'line',
                    'label' => __('plugins.themes.oreTheme.option.displayStats.line'),
                ],
            ],
            'default' => 'none',
        ]);
    ...
    {
        return __('plugins.themes.oreTheme.name');
    }
    ...
    {
        return __('plugins.themes.oreTheme.description');
    }
    ...
    public function getSwiperI18n(): string
    {
        return 'var pkpDefaultThemeI18N = ' . json_encode([
            'nextSlide' => __('plugins.themes.oreTheme.nextSlide'),
            'prevSlide' => __('plugins.themes.oreTheme.prevSlide'),
        ]);
    }
}
