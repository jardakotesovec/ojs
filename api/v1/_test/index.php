...
// /scenarios/context (canonical, cross-app) and its OJS alias
// /scenarios/journal build a scratch (or baseline) context;
...
foreach (['/_test/scenarios/context', '/_test/scenarios/journal'] as $contextRoute) {
